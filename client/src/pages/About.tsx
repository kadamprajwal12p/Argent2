            ...
            <div className="space-y-8">
              <div className="prose prose-slate prose-lg max-w-none text-slate-600">
                <p className="font-medium text-slate-900">
                  Intercorp began with a simple yet powerful vision: to bring high-performance nutritional and hygiene solutions within reach of every consumer.
                </p>
                <p>
                ...
                <p>
                  From fortifying essential staples like milk and flour for better public health to providing military-grade hygiene solutions for extreme environments, Intercorp stands as a pillar of reliability and excellence.
                </p>
              </div>
          ...
          <div className="relative overflow-hidden p-12 lg:p-20 bg-slate-900 rounded-[3rem] text-white text-center max-w-5xl w-full mx-auto">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-slate-100 mb-12 max-w-2xl mx-auto font-medium opacity-90">
                Experience the precision of Intercorp's advanced nutrition and hygiene solutions. Let's build a healthier future together.
              </p>
