...
import { ShieldCheck, Sparkles, Droplets, CheckCircle2, Award, Beaker, Globe, Clock, Zap, ArrowRight } from "lucide-react";
...
const DIFFERENCES = [
  { icon: Beaker, title: "Scientific Hygiene", desc: "Formulated for professional and home use" },
  { icon: ShieldCheck, title: "Total Protection", desc: "Effective against a wide range of pathogens" },
  { icon: Globe, title: "Sustainable Supply", desc: "Responsibly sourced high-grade alcohol" }
];

const products = [
  { 
    name: "FOMY Alcohol Gel", 
  ...
  { 
    name: "FOMY Surface Disinfectant", 
...
export default function FomyHygiene() {
  return (
        ...
        <div className="container px-4">
              ...
              <div className="relative space-y-8">
                <div>
                  ...
                  <h2 className="text-4xl md:text-5xl font-display font-bold text-slate-900 mb-8 leading-tight">
                    Clean Hands, <span className="text-blue-600">Healthy Life</span>
                  </h2>
                </div>
                
                <div className="prose prose-slate prose-lg max-w-none text-slate-600 space-y-6">
                  <p>
                    FOMY hygiene products are the result of intensive research into microbiological safety and skin health.
                  </p>
                  <p>
                    Our sanitizers and soaps are designed to provide maximum protection without compromising the integrity of the skin's natural barrier.
                  </p>
                  <div className="p-6 bg-slate-50 rounded-2xl border-l-4 border-blue-600 font-semibold text-slate-900">
                    "Setting the standard for professional hygiene and long-lasting protection."
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="p-8 bg-slate-900 rounded-[2rem] text-white">
                ...
                <p className="text-slate-400 leading-relaxed text-sm">
                  Our hospital-grade formulas provide extended protection against a wide range of pathogens, keeping you safe between washes.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="space-y-16">
            <div className="text-center max-w-2xl mx-auto">
              <h2 className="text-4xl font-display font-bold text-slate-900 mb-4">Hygiene Range</h2>
              <p className="text-slate-500 font-medium">Professional hand hygiene and sanitization products.</p>
            </div>
